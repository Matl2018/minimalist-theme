	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			if ( is_front_page() && is_home() ) :
				...
				<img class=image-title src="<?php echo get_stylesheet_directory_uri(); ?>/img/logo-text.png" alt="Glasgow Bike Store logo" /> </a></h1>
				<?php
			else :
				?>
				<p class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img class=image-title  src="<?php echo get_stylesheet_directory_uri(); ?>/img/logo-text.png" alt="Glasgow Bike Store logo" /></p>
				<?php
			endif;
